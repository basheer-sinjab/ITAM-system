...
import { P as Boxes, _ as Pencil, c as Trash2, h as Plus, s as TriangleAlert, v as Package } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/inventory-Bmq-e3E6.js
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									variant: "ghost",
									onClick: () => {
										if (window.confirm(`هل أنت متأكد من حذف المنتج "${item.name}" من المخزون؟`)) remove.mutate(item.id);
									},
