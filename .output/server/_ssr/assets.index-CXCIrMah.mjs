...
import { C as Monitor, G as Boxes, a as UserRound, h as Search, v as Plus } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/assets.index-CXCIrMah.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: filtered.map((asset) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						style: { borderTopColor: department?.color || branch?.color || "#2563eb" },
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PrinterImage, {
							...
							children: [
								...
								department ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScopeColorBadges, {
									department,
									branch
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground",
									children: "قسم غير محدد"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function AssetForm({ open, onOpenChange, departments = [], asset, onSaved }) {
	const queryClient = useQueryClient();
	const [templateId, setTemplateId] = (0, import_react.useState)(NONE);
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						!asset && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "قالب الجهاز (اختياري)" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
									value: templateId,
									onValueChange: (value) => {
										setTemplateId(value);
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "ابدأ من قالب محفوظ" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
										value: NONE,
										children: "بدون قالب"
									}), templates.map((template) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem, {
										value: template.id,
										children: [
											template.name,
											" — ",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground",
									children: "يمكنك إدارة القوالب من الإعدادات ← قوالب الأجهزة."
								})
							]
						}),
						[
