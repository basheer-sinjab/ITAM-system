...
import { N as Building2, h as Plus, i as UsersRound, p as Search } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./people-departments-rll1yQtk.mjs";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-LVzmfYUX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/people-departments-CwgHlHim.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "rounded-full bg-primary/10 px-2 py-0.5 text-xs text-primary",
												children: [filteredDepartments.filter((department) => department.branch === branch.name).length, " أقسام"]
											})
										]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "grid gap-4 p-4 md:grid-cols-2",
									children: filteredDepartments.filter((department) => department.branch === branch.name).map((department) => {
							...
							}, branch.id)), filteredDepartments.filter((department) => !department.branch || !branches.some((branch) => branch.name === department.branch)).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
								open: true,
								className: "surface-panel overflow-hidden group",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
									className: "flex cursor-pointer list-none items-center justify-between border-b p-5 marker:hidden",
									...
									className: "grid gap-4 p-4 md:grid-cols-2",
									children: filteredDepartments.filter((department) => !department.branch || !branches.some((branch) => branch.name === department.branch)).map((department) => {
										const people = employees.filter((employee) => employee.department_id === department.id);
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											to: "/people-departments/$id",
											params: { id: department.id },
