...
function PrinterImage({ path, alt, className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
		...
		alt,
		loading: "lazy",
		className: cn("bg-secondary object-contain", className)
	});
}
//#endregion
