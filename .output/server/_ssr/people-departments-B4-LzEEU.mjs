...
import { M as Building2, i as UsersRound, m as Plus } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./people-departments-CjfQNPwl.mjs";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-LVzmfYUX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/people-departments-B4-LzEEU.js
				...
				children: [
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UsersRound, { className: "absolute right-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
											...
											children: [departmentEmployees.map((employee) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														...
														children: employeeDepartment(employee)?.name || "قسم غير محدد"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
														className: "mt-3 text-sm",
														children: ["التراخيص: ", licenseAssignments.filter((assignment) => assignment.employee_id === employee.id).length]
													})
												]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "surface-panel flex justify-end p-3",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "rounded-full bg-primary/10 px-2 py-0.5 text-xs text-primary",
												children: [departments.filter((department) => department.branch === branch.name).length, " أقسام"]
											})
										]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "grid gap-4 p-4 md:grid-cols-2",
									children: departments.filter((department) => department.branch === branch.name).map((department) => {
							...
							}, branch.id)), departments.filter((department) => !department.branch || !branches.some((branch) => branch.name === department.branch)).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
								open: true,
								className: "surface-panel overflow-hidden group",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
									className: "flex cursor-pointer list-none items-center justify-between border-b p-5 marker:hidden",
									...
									className: "grid gap-4 p-4 md:grid-cols-2",
									children: departments.filter((department) => !department.branch || !branches.some((branch) => branch.name === department.branch)).map((department) => {
										const people = employees.filter((employee) => employee.department_id === department.id);
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											to: "/people-departments/$id",
											params: { id: department.id },
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: branches.map((branch) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									...
									children: ["الأقسام: ", departments.filter((department) => department.branch === branch.name).length]
								})]
							}, branch.id))
						})]
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
						label: "الفرع",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
							value: branch || "__none__",
							onValueChange: (value) => setBranch(value === "__none__" ? "" : value),
