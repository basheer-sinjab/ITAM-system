...
import { W as Building2, h as Search, i as UsersRound, v as Plus } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./people-departments-Rthf3Zh3.mjs";
import { n as ColorField, t as COLOR_PALETTE } from "./ColorField-DnyooLbp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/people-departments-CGTjhLOQ.js
...
function PeopleDepartments() {
	...
	const [newBranchColor, setNewBranchColor] = (0, import_react.useState)(COLOR_PALETTE[0]);
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														style: { backgroundColor: department.color || branches.find((branch) => branch.id === department.branch_id)?.color || COLOR_PALETTE[0] }
													}),
													department.name,
													" -",
													" ",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												style: { backgroundColor: branch.color || COLOR_PALETTE[0] }
											}),
											branch.name,
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "rounded-full bg-primary/10 px-2 py-0.5 text-xs text-primary",
									...
									children: filteredDepartments.filter((department) => department.branch_id === branch.id || !department.branch_id && department.branch === branch.name).map((department) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											style: {
												borderTopWidth: 4,
												borderTopColor: department.color || branch.color || COLOR_PALETTE[0]
											},
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-start justify-between gap-3",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
									...
									onClick: async () => {
										...
										setNewBranch("");
										setNewBranchColor(COLOR_PALETTE[(branches.length + 1) % COLOR_PALETTE.length]);
...
function DepartmentForm({ close, saved, branches = [] }) {
	...
	const [color, setColor] = (0, import_react.useState)(COLOR_PALETTE[branches.length % COLOR_PALETTE.length]);
