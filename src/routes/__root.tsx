...
import { OdooUiLocalizer } from "@/lib/ui-localization";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "ITAMFloss لإدارة الأصول والمخزون والصيانة والتراخيص.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: staticAsset("/favicon.ico"), type: "image/x-icon" },
    ],
  }),
  shellComponent: odooRuntime() ? undefined : RootShell,
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Outlet />
      <Toaster position="top-center" dir={languageDirection()} />
    </QueryClientProvider>
  );
}
