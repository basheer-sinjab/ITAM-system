...
import { i as TONER_COLORS, n as PRINTER_STATUS, o as formatDate, t as MAINTENANCE_TYPES } from "./pms-OlFSYXzg.js";
...
import { n as useLookups } from "./PrinterFormDialog-C3jcuetZ.js";
import { t as QrCodeBox } from "./QrCodeBox-DTgmjoyt.js";
...
function ReportsPage() {
	...
	const [kind, setKind] = useState("printers");
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					children: [/* @__PURE__ */ jsx(Printer, { className: "size-4" }), "طباعة / حفظ PDF"]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "نوع التقرير" }), /* @__PURE__ */ jsxs(Select, {
							value: kind,
							onValueChange: (v) => setKind(v),
							children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsx(SelectContent, { children: REPORTS.map((r) => /* @__PURE__ */ jsx(SelectItem, {
								value: r.value,
								children: r.label
							}, r.value)) })]
						})]
					...
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "الفرع" }), /* @__PURE__ */ jsxs(Select, {
							value: branch,
							...
							children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsxs(SelectContent, { children: [/* @__PURE__ */ jsx(SelectItem, {
								value: ALL,
								children: "كل الفروع"
							}), (lookups?.branches ?? []).map((b) => /* @__PURE__ */ jsx(SelectItem, {
								value: b.id,
								children: b.name
							}, b.id))] })]
						})]
					...
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "القسم" }), /* @__PURE__ */ jsxs(Select, {
							value: dept,
							onValueChange: setDept,
							children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }), /* @__PURE__ */ jsxs(SelectContent, { children: [/* @__PURE__ */ jsx(SelectItem, {
								value: ALL,
								children: "كل الأقسام"
							}), (lookups?.departments ?? []).map((d) => /* @__PURE__ */ jsx(SelectItem, {
								value: d.id,
								children: d.name
							}, d.id))] })]
						})]
					...
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "من تاريخ" }), /* @__PURE__ */ jsx(Input, {
							type: "date",
							value: from,
					...
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ jsx(Label, { children: "إلى تاريخ" }), /* @__PURE__ */ jsx(Input, {
							type: "date",
							value: to,
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					kind === "printers" && /* @__PURE__ */ jsx(ReportTable, {
						head: [
							"رقم الأصل",
							"الاسم",
							"الموديل",
					...
					kind === "toners" && /* @__PURE__ */ jsx(ReportTable, {
						head: [
							"الحبر",
							"الكود",
							"اللون",
					...
					kind === "maintenance" && /* @__PURE__ */ jsx(ReportTable, {
						head: [
							"التاريخ",
							"الطابعة",
							"النوع",
					...
					kind === "toner-usage" && /* @__PURE__ */ jsx(ReportTable, {
						head: ["الحبر", "إجمالي الاستهلاك"],
						rows: [...usage.entries()].sort((a, b) => b[1] - a[1]).map(([name, qty]) => [name, String(qty)])
					}),
					kind === "qr-sheet" && /* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-4",
						children: printers.map((p) => /* @__PURE__ */ jsxs("div", {
							className: "rounded-lg border p-3 text-center",
							children: [/* @__PURE__ */ jsx(QrCodeBox, {
								value: p.asset_id,
								size: 130
							}), /* @__PURE__ */ jsx("p", {
...
function ReportTable({ head, rows }) {
	...
	return /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsx(TableRow, { children: head.map((h) => /* @__PURE__ */ jsx(TableHead, {
		className: "text-right",
		children: h
	}, h)) }) }), /* @__PURE__ */ jsx(TableBody, { children: rows.map((r, i) => /* @__PURE__ */ jsx(TableRow, { children: r.map((c, j) => /* @__PURE__ */ jsx(TableCell, { children: c }, j)) }, i)) })] });
}
//#endregion
