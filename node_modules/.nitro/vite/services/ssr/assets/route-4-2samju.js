...
import { Droplets, FileText, LayoutDashboard, Printer, Settings, Truck } from "lucide-react";
		...
		children: [/* @__PURE__ */ jsxs("aside", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsx(Printer, { className: "size-5" })
				...
				children: NAV.map((item) => /* @__PURE__ */ jsxs(Link, {
					to: item.to,
					...
					children: [/* @__PURE__ */ jsx(item.icon, { className: "size-[18px]" }), item.label]
				}, item.to))
			})]
		}), /* @__PURE__ */ jsxs("div", {
